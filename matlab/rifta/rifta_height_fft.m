...
Tdg = rifta_height_inverse_filter(Z_to_remove_dw, B, 1);
...
Z_to_remove_ca = Z_to_remove_dw(ca_in_dw_v_s:ca_in_dw_v_e, ca_in_dw_u_s:ca_in_dw_u_e);
...
% Get optimized gamma
gamma = rifta_height_gamma_optimization(gamma0, Z_to_remove_dw, B, dg_range, ca_range);

% 2. Use the optimal gamma to do the inverse filtering again
Tdg = rifta_height_inverse_filter(Z_to_remove_dw, B, gamma);
